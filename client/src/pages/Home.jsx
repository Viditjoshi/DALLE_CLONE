    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div className='font-extrabold text-[#222328] text-[32px]'>
                ...
                <p className='mt-2 text-[#666e75] text-[14px] max-w-[500px]'>Browse through a collection of imaginative nd visually stunning images genered by DELLE AI</p>
            </div>
            <div className='mt-16'>
                <FormField />
            </div>
                ...
                {loading ? (<div className='flex justify-center items-center'>
                    ...
                    <>
                        ...
                        <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>
                            {searchText ? (<RenderCards data={[]} title="No search results found" />) : (<RenderCards data={[]} title="No post found" />)}
                        </div>
                    </>
                )}
            </div>
